...
void cb_prefs_gui(GtkWidget *widget, gpointer data)
{
   ...
   port_entry = new_gtk_entry_with_max_length(MAX_PREF_LEN - 2);
   ...
   backups_entry = new_gtk_entry_with_max_length(2);
   ...
   mail_command_entry = new_gtk_entry_with_max_length(MAX_PREF_LEN - 2);
   ...
   todo_days_due_entry = new_gtk_entry_with_max_length(MAX_PREF_LEN - 2);
   ...
   ext_editor_entry = new_gtk_entry_with_max_length(MAX_PREF_LEN - 2);
   ...
   alarm_command_entry = new_gtk_entry_with_max_length(MAX_PREF_LEN - 2);
